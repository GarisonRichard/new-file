...
def admin_view_far(request):
    ...
    abo=Farmertable.objects.filter(f1="approved")
    if request.POST:
        a1=request.POST['a1']
        a2=request.POST['a2']
        a2=int(a2)
    ...
    return render(request,'admin/admin_view_far.html',{"abc":abc,"abo":abo})

def admin_view_user(request):
    abc=Usertable.objects.filter(u1="pending")
    abo=Usertable.objects.filter(u1="approved")
    if request.POST:
        a1=request.POST['a1']
        a2=request.POST['a2']
        a2=int(a2)
    ...
    return render(request,'admin/admin_view_user.html',{"abc":abc,"abo":abo})

def admin_view_inv(request):
    abc=Investortable.objects.filter(inv1="pending")
    abo=Investortable.objects.filter(inv1="approved")
    if request.POST:
        a1=request.POST['a1']
        a2=request.POST['a2']
        a2=int(a2)
    ...
    return render(request,'admin/admin_view_inv.html',{"abc":abc,"abo":abo})
